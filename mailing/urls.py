...
from mailing.views import (MainView, MailingCreateView, MailingListView, MailingDetailView, MailingUpdateView,
                           MailingDeleteView, MessageCreateView, MessageListView, MessageUpdateView, MessageDeleteView,
                           ClientCreateView, ClientListView, ClientUpdateView, ClientDeleteView, LogsListView)
